...
class SchemaExtensionsV2Tests(unittest.TestCase):
    def test_bundle_contains_thirty_one_generated_and_published_documents(self):
        bundle = schema_bundle()
        self.assertEqual(31, len(bundle))
    ...
    def test_release_schema_gate_resolves_local_references(self):
        ...
        if optional["validator_available"]:
            ...
            self.assertEqual(31, strict["schema_count"])
            self.assertEqual(31, strict["sample_count"])
