    ...
    def bundle():
        ...
        properties.update({
            ...
            "compatibility": {
                "type": "object",
                "required": [
                    "minimum_client_protocol", "current_client_protocol", "supported_protocols",
                    "unknown_fields", "missing_optional_features", "removed_features",
                    "future_protocols", "downgrade",
                ],
                "properties": {
                    "minimum_client_protocol": {"type": "integer", "minimum": 1},
                    "current_client_protocol": {"type": "integer", "minimum": 1},
                    "supported_protocols": {"type": "array", "items": {"type": "integer", "minimum": 1}},
