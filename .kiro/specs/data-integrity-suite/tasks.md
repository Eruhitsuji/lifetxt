...
- [x] 2. Add strict integrity profiles
  ...
  - _Depends: 1_
  - _Tracked by: https://github.com/Eruhitsuji/lifetxt/issues/520_

- [x] 3. Add cross-file ID and reference registry auditing
...
- [x] 4. Add local import and sync reconciliation audit
...
- [x] 5. Add recovery and transaction integrity diagnosis
...
- [x] 6. Add non-mutating repair plan generation
...
- [x] 7. Document, trace, and verify each implementation slice
