        ...
        (
            (
                ...
                _s(
                    ...
                    {
                        "id": {"type": "string"},
                        "role": {"enum": ["owner", "editor", "reader", "auditor"]},
            ...
            (
                ...
                _s(
                    ...
                    {
                        "schema": {"const": "remote-access-policy-v1.schema.json"},
                        "contract_version": {"const": "1"},
                        "enabled": {"type": "boolean"},
                        "browser_ui": {"type": "boolean"},
                        "authentication": {
                            "type": "array",
                            "items": {"type": "string"},
                        },
            ...
            (
                ...
                _s(
                    ...
                    "Remote session",
                    {
                        "schema": {"const": "remote-session-v1.schema.json"},
                        "principal": {"$ref": BASE + "remote-principal-v1.schema.json"},
                        "authentication": {"type": "string"},
                        "request_id": {"type": "string"},
                    },
                    ("schema", "principal", "authentication", "request_id"),
                ),
            ),
            (
                ...
                _s(
                    ...
                    "Remote snapshot",
                    {
                        "schema": {"const": "remote-snapshot-v1.schema.json"},
            ...
            (
                ...
                _s(
                    ...
                    "Remote audit event",
                    {
                        "schema": {"const": "remote-audit-event-v1.schema.json"},
                        "version": {"const": "1"},
                    ...
                    ("schema", "version", "at", "request_id", "action", "outcome"),
                ),
            ),
            (
...
def schema_samples_v19():
    ...
    return OrderedDict(
        (
            ...
            (
                "remote-access-policy-v1.schema.json",
                capability({"remote": {"enabled": True}}),
            ),
            (
                "remote-session-v1.schema.json",
                {
                    "schema": "remote-session-v1.schema.json",
                    "principal": {"id": "alice", "role": "reader", "scopes": ["read"]},
            ...
            (
                "remote-audit-event-v1.schema.json",
                {
                    ...
                    "principal": "alice",
                    "role": "reader",
                    "action": "GET /api/remote/v1/snapshot",
                    "outcome": 200,
                    "client": "127.0.0.1",
                    "detail": {},
                },
...
def install_schema_extensions_v19():
    ...
    if getattr(release_policy, "_lifetxt_schema_extensions_v19", False):
        return
    ob = safety_foundation.schema_bundle
    osamp = release_policy._schema_samples

    def bundle():
        r = OrderedDict(ob())
        r.update(schema_bundle_v19())
        return r

    def samples():
        r = OrderedDict(osamp())
        r.update(schema_samples_v19())
        return r

    safety_foundation.schema_bundle = bundle
    release_policy.schema_bundle = bundle
    release_policy._schema_samples = samples
    release_policy._lifetxt_schema_extensions_v19 = True
