...
RECOMMENDED_KEYS_BY_TYPE = {
    ...
    "D": ("due", "priority", "importance", "owner", "assignee", "project", "id"),
    "R": ("at", "on", "project", "context", "note", "id"),
    "H": ("repeat", "at", "on", "project", "tag", "id"),
    "N": ("project", "tag", "note", "body", "url", "id"),
    "S": ("from", "state", "to", "person", "service", "visibility"),
    "M": (
        "sender",
        "recipient",
        "notify_at",
