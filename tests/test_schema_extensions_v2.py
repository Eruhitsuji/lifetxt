...
class SchemaExtensionsV2Tests(unittest.TestCase):
    def test_bundle_contains_fifty_six_generated_and_published_documents(self):
        bundle = schema_bundle()
        self.assertEqual(56, len(bundle))
    ...
    def test_release_schema_gate_resolves_local_references(self):
        ...
        if optional["validator_available"]:
            ...
            self.assertEqual(56, strict["schema_count"])
            self.assertEqual(56, strict["sample_count"])
