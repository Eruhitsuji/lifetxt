...
def prepare(operation, staged_rows, journal_dir, transaction_id_value=None, now=None):
...
def cleanup_terminal(journal_dir, older_than_days=30, force=False, now=None):
    root = os.path.abspath(journal_dir)
