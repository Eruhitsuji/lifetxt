    ...
    return OrderedDict(
        (
            (
                ...
                {
                    "$schema": DRAFT,
                    "$id": BASE + "editor-session-v1.schema.json",
                    "title": "lifetxt safe editor session v1",
                    "type": "object",
                    "required": [
                        "path",
                        "before_revision",
                    ...
                    "properties": {
                        ...
                        "edited_revision": {"type": "string"},
                        "after_revision": {"type": "string"},
                        "source_changed_while_editing": {"type": "boolean"},
            ...
            (
                ...
                {
                    "$schema": DRAFT,
                    "$id": BASE + "directory-package-v1.schema.json",
                    "title": "lifetxt deterministic directory package v1",
                    "type": "object",
                    "required": [
                        "package_version",
                        "file_count",
            ...
            (
                ...
                {
                    "$schema": DRAFT,
                    "$id": BASE + "attachment-open-v1.schema.json",
                    "title": "lifetxt attachment open plan v1",
                    "type": "object",
                    "required": [
                        "action",
                        "path",
                    ...
                    "properties": {
                        ...
                        "metadata_revision": {"type": ["string", "null"]},
                        "metadata_written": {"type": "boolean"},
            ...
            (
                ...
                {
                    "$schema": DRAFT,
                    "$id": BASE + "transaction-policy-admin-v1.schema.json",
                    "title": "lifetxt transaction policy document v1",
                    "type": "object",
                    "required": [
                        "policy_version",
                        "updated_at_utc",
            ...
            (
                ...
                {
                    "$schema": DRAFT,
                    "$id": BASE + "transaction-preflight-v1.schema.json",
                    "title": "lifetxt transaction startup preflight v1",
                    "type": "object",
                    "required": [
                        "ok",
                        "journal_dir",
            ...
            (
                ...
                {
                    "$schema": DRAFT,
                    "$id": BASE + "clock-skew-v1.schema.json",
                    "title": "lifetxt remote clock skew v1",
                    "type": "object",
                    "required": [
                        "server_time_utc",
                    ...
                    "properties": {
                        ...
                        "warning_seconds": {"type": "number", "minimum": 0},
                        "reject_seconds": {"type": "number", "minimum": 0},
                        "client_time_utc": {"type": ["string", "null"]},
                        "skew_seconds": {"type": ["number", "null"]},
                        "absolute_skew_seconds": {
                            "type": ["number", "null"],
                            "minimum": 0,
                        },
                        "state": {"enum": ["not_measured", "ok", "warning", "reject"]},
        ...
        (
            (
                "editor-session-v1.schema.json",
                {
                    "path": "/tmp/life.txt",
                    "temporary_path": None,
                    "command": ["vi", "/tmp/edit/life.txt"],
                    "before_revision": h,
                    "current_revision": h,
                    "edited_revision": h,
                    "after_revision": h,
                    "source_changed_while_editing": False,
                    "reconciled": False,
                    "changed": False,
                    "review_only": True,
                    "written": False,
            ...
            (
                "directory-package-v1.schema.json",
                {
                    ...
                    "file_count": 1,
                    "total_bytes": 1,
                    "files": [{"path": "a.txt", "size": 1, "sha256": h}],
                    "package_sha256": h,
                },
            ),
            (
            ...
            (
                "clock-skew-v1.schema.json",
                {
                    "server_time_utc": "2026-07-24T00:00:00Z",
                    "server_authoritative": True,
                    "warning_seconds": 30.0,
                    "reject_seconds": 300.0,
